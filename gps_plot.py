...
fig1 = plt.figure()
plt.hist([fspeed,mspeed], bins,normed=True, label=["female", "male"])
...
fig2 = plt.figure()
plt.hist([staffspeed, studentsspeed],bins, normed=True, label=["staff/faculty","students"])
plt.xlabel("speed (kph)")
plt.ylabel("probability")
plt.legend()
plt.tight_layout()
...
fig3 = plt.figure()
plt.hist(fspeed+mspeed, bins, normed=True, rwidth=0.9, label="all participants")
plt.xlabel("speed (kph)")
plt.ylabel("probability")
plt.legend()
plt.tight_layout()
